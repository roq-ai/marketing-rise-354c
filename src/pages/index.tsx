...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Marketing Rise`}</title>

        <meta
          name="description"
          content="Experience the power of curated content with Marketing Rise - your ad-free gateway to the world's leading tech websites."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1531297484001-80022131f5a1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0ZWNofGVufDB8fHx8MTY5MDE5OTE5NHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the power of curated content with Marketing Rise - your ad-free gateway to the world's leading tech websites.`}
            </Text>
            <Box
